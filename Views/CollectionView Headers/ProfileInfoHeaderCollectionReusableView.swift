...
protocol ProfileInfoHeaderCollectionReusableViewDelegate: AnyObject {
    ...
    func profileHeaderDidTapEditProfileInfoHeaderCollectionReusableViewDelegateeButton(_ header: ProfileInfoHeaderCollectionReusableView)
}
final class ProfileInfoHeaderCollectionReusableView: UICollectionReusableView {
    ...
    private let nameLabel: UILabel = {
        let label = UILabel()
        label.text = "Paratthakorn Sribunyong"
    ...
    @objc private func didTapEditProfileButton() {
        delegate?.profileHeaderDidTapEditProfileInfoHeaderCollectionReusableViewDelegateeButton(self)
    }
}
