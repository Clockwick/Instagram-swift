...
class LoginViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        termsButton.frame = CGRect(x: 25, y: view.height - view.safeAreaInsets.bottom - 100, width: view.width - 50, height: 52.0)
        privacyButton.frame = CGRect(x: 25, y: view.height - view.safeAreaInsets.bottom - 50, width: view.width - 50, height: 52.0)
    ...
    @objc private func didTapTermsButton() {
        guard let url = URL(string: "https://web.facebook.com/help/instagram/termsofuse?_rdc=1&_rdr") else {
            return
        }
